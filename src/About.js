      ...
      <Element name="about-section" className="element">
        <section className="about-us">
          <div className="about-content">
            <p className='lead mb-3'>Welcome to Elizabeth's Cleaning Services, where cleanliness meets excellence.
            ...
            <p className='lead mb-3'>Our professional team is the heart of Elizabeth's Cleaning Services. Trained,
            ...
            <p className='lead mb-3 '>What sets us apart is our holistic approach to cleaning. We embrace eco-friendly practices,
          ...
          <button className='btn btn-outline-dark btn-lg my-5'>Request A Quote</button>
        </section>
      </Element>
    </div>
  );
